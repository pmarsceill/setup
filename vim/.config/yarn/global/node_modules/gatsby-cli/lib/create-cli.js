...
const _require2 = require(`./util/version`),
      getLocalGatsbyVersion = _require2.getLocalGatsbyVersion;
...
const _require3 = require(`gatsby-telemetry`),
      trackCli = _require3.trackCli,
      setDefaultTags = _require3.setDefaultTags,
      setTelemetryEnabled = _require3.setTelemetryEnabled;
...
function isLocalGatsbySite() {
  ...
  try {
    let _require4 = require(path.resolve(`./package.json`)),
        dependencies = _require4.dependencies,
        devDependencies = _require4.devDependencies;
