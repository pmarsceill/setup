...
const reporter = {
  ...
  error(errorMeta, error) {
    ...
    if (structuredError) reporterInstance.error(structuredError); // TODO: remove this once Error component can render this info
    ...
    return {
      ...
      setStatus(status) {
        ...
        trackCli(`ACTIVITY_DURATION`, {
          name: name,
          duration: Math.round(convertHrtime(process.hrtime(startTime))[`milliseconds`])
        });
        span.finish();
        activity.done();
      },
