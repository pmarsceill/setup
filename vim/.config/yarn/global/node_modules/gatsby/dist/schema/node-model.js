...
const determineResolvableFields = (schemaComposer, schema, type, fields) => {
  ...
  Object.keys(fields).forEach(fieldName => {
    ...
    const needsResolve = typeComposer.getFieldExtension(fieldName, `needsResolve`);

    if (_.isObject(field) && gqlField) {
      const innerResolved = determineResolvableFields(schemaComposer, schema, gqlFieldType, field);
...
const addRootNodeToInlineObject = (rootNodeMap, data, nodeId, isNode = false) => {
